...
class BrowserWebRtcService(QObject):
    ...
    def stop(self, payload: dict[str, Any] | None = None) -> dict[str, Any]:
        ...
        if self.loop:
            future = asyncio.run_coroutine_threadsafe(self._close_peers(peer_id), self.loop)
    ...
    async def _close_peers(self, peer_id: str = "") -> None:
        ...
        for current_peer_id in list(self.peer_connections.keys()):
